...
{
    public class HandOverBiesController : BaseController
    {
        ...
        public ActionResult HandOverBy(int trId)
        {
            ...
            HandOverBy handOverby = new HandOverBy();
            handOverby.Name = repo.UserRepository.GetByUserId(userId).Username;
            handOverby.Address = repo.DepartmentRepository.GetDepartmentByUser(userId).DepartmentAddress;
            handOverby.Date = DateTime.Now;
            ...
            if (ModelState.IsValid)
            {
              ...
              //  handoverby.TrasmittalOUTs = trOUTList;
               ...
               //repo.orbl.InsertOrUpdate(handoverby);
                ...
                return RedirectToRoute(new { controller = "ReceivedBies", action = "ReceivedByForTrOUT", trId = _trID });
        ...
        public ActionResult Create(HandOverBy handoverby)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //return View("Create");
                return RedirectToRoute(new { controller = "ReceivedBies", action = "ReceivedBy", trId = _trID });
            }
