...
namespace WareHouseMVC.Controllers
{
    public class ZonesController : BaseController
    {
        ...
        public ActionResult GetProjectsNew(long DepartmentID)
        {
           // var projects = repo.ProjectRepository.FindByDepartmentID(DepartmentID);
            ViewBag.PossibleProjects = repo.ProjectRepository.FindByDepartmentID(DepartmentID);
            return View();
        }
        ...
        public ActionResult GetPersonsNew(long DepartmentID)
        {
           // var persons = repo.ContactPersonRepository.FindByDepartmentID(DepartmentID);
            ViewBag.PossibleContactPerson = repo.ContactPersonRepository.FindByDepartmentID(DepartmentID);
            return View();
        }
