...
{
    public class AssignBoxTrOUTsController : BaseController
    {
        ...
        private List<AssignBox> SaveData(DataTable dt,long _wID)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                _assignbox = repo.AssignBoxRepository.GetByWidandTrStatus(AssignBoxId, _wID, Convert.ToInt64(EnumHelper.Status.WareHouse_Assigned));
