...
{
    public class ReceivedBiesController : BaseController
    {
        ...
        public ActionResult ReceivedByForTrOUT(long trId)
        {
            ...
            ReceivedBy receivedBy = new ReceivedBy();
            receivedBy.Name = repo.UserRepository.GetByUserId(userId).Username;
            receivedBy.Address = repo.DepartmentRepository.GetDepartmentByUser(userId).DepartmentAddress;
            receivedBy.Date = DateTime.Now;
            ...
            return View("AddReceivedBy", receivedBy);
        }
        ...
        public ActionResult ReceivedByForTrOUT(ReceivedBy receivedby, string trId)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToRoute(new { controller = "Items", action = "AddBoxesForTrOUT", trId = _trID });
        ...
        public ActionResult Create(ORBLOperator receivedby, string trId)
        {
            ...
            ViewBag.PossibleOperator=repo.ORBLOperatorRepository.AllIncluding();
              ...
              //  ViewBag.AllReceivedBy = transIN.ReceivedBy;
                ...
                return RedirectToRoute(new { controller = "Items", action = "CreateWitTrINId", trId = _trID });
