...
{
    public class ReportViewModelForEmptyBoxRecuisition
    {
          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForEmptyBoxRecuisition()
        {
        ...
        public string EmptyBoxDate { get; set; }
        ...
        public string ReporExportExtention
        {
            get
            {
                switch (this.Format)
                {
                    case ReportViewModelForEmptyBoxRecuisition.ReportFormat.Word: return ".doc";
                    case ReportViewModelForEmptyBoxRecuisition.ReportFormat.Excel: return ".xls";
                    default:
                        return ".pdf";
                }
            }
        ...
        public byte[] RenderReport()
        {
            ...
            localReport.SetParameters(new ReportParameter("ReceivedByAddress", this.ReceivedByAddress ?? "N/A"));
            localReport.SetParameters(new ReportParameter("ReceivedByPosition", this.ReceivedByPosition ?? "N/A"));
            localReport.SetParameters(new ReportParameter("ReceivedByDate", this.ReceivedByDate));
            localReport.SetParameters(new ReportParameter("EmptyBoxDate", this.EmptyBoxDate));
            ...
            localReport.SetParameters(new ReportParameter("EmptyboxNo", this.EmptyboxNo));
