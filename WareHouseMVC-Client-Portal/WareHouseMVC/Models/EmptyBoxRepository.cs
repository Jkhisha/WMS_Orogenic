...
namespace WareHouseMVC.Models
{
    public class EmptyBoxRepository : IEmptyBoxRepository
    {
        ...
        public IQueryable<EmptyBox> GetFilteredByDept(long clientId, long departmentId, string subDepartment)
        {
        ...
        public void InsertOrUpdate(EmptyBox emptybox)
        {
            ...
            {
                var existingEntity = context.EmptyBoxes.Find(emptybox.EmptyBoxId);

                if (existingEntity != null)
                {
                    context.Entry(existingEntity).CurrentValues.SetValues(emptybox);
                }
                else
                {
                    context.EmptyBoxes.Attach(emptybox);
        ...
        public void InsertOrUpdateEmptyBoxBarcode(EmptyBoxBarcode emptyboxBarcode)
        {
            ...
            {
                var existingEntity = context.EmptyBoxeBarcodes.Find(emptyboxBarcode.Id);

                if (existingEntity != null)
                {
                    context.Entry(existingEntity).CurrentValues.SetValues(emptyboxBarcode);
                }
                else
                {
                    context.EmptyBoxeBarcodes.Attach(emptyboxBarcode);
        ...
        public  List<EmptyBox> GetByClientId(long clientId)
        {
            return context.EmptyBoxes.Where(s => s.ClientID == clientId).ToList();
        }
    }
