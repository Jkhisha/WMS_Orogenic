...
{
    public class ReportViewModelForDelPendingBox
    {
          ...
          public ReportViewModelForDelPendingBox()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForDelPendingBox.ReportFormat.Word: return ".doc";
                      case ReportViewModelForDelPendingBox.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
