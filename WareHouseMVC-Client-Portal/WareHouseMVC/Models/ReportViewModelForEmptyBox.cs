...
{
    public class ReportViewModelForEmptyBox
    {
          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForEmptyBox()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForEmptyBox.ReportFormat.Word: return ".doc";
                      case ReportViewModelForEmptyBox.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
