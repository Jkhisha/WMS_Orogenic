...
namespace WareHouseMVC.Controllers
{
    public class HeightsController : Controller
    {
        ...
        public ViewResult Index(int? page)
        {
            ...
            ViewBag.NoofHeight = repo.HeightRepository.All.Count();
            return View(repo.HeightRepository.AllIncluding(height => height.Level, height => height.Level.Rack, height => height.Level.Rack.Train, height => height.Level.Rack.Train.Zone, height => height.Level.Rack.Train.Zone.Floor, height => height.Level.Rack.Train.Zone.Floor.Warehouse).OrderBy(o => o.HeightName).ToPagedList(pageNumber, pageSize));
