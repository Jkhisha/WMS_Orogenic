    ...
    public class ReportsController : Controller
    {
        ...
        public ActionResult DestructionPeriod(UpcomingDestructionViewModel model)
        {
            ...
            if (model.ClientID == 0 || model.ClientID == -1)
            {
                ...
                itemList = repo.ItemRepository.GetDestructionPeriodByMonthCount(model.MonthCount);
            }
            else
            {
                itemList = repo.ItemRepository.GetDestructionPeriodByMonthCountwithClient(model.MonthCount,model.ClientID);
            }
        ...
        public ActionResult PrintEmptyBoxBarCode(string barcodes)
        {
            //int pageNumber = (page ?? 1);
            //User _user = repo.UserRepository.GetUserByUserName(HttpContext.User.Identity.Name);
            //long _wID = 0;
            ...
            var reportViewModel = repo.BarCodeRepository.GetEmptyBoxBarCodeReport(barcodes);
        ...
        //public ActionResult PrintClient1Barcode(string barcodes)
        //{
        //    LocalReport report = new LocalReport();
        //    report.ReportPath = Server.MapPath("~/ReportsHolder/Client1Barcode.rdlc");
        ...
        //        {
        //            dt.Rows.Add(barcode.Trim());
        //        }
        //    }
        //    report.DataSources.Add(new ReportDataSource("DataSet1", dt));

        //    // 2. Render PDF (FIXED: removed unused 'streams' parameter)
        ...
        //        out warnings); // Removed 'streams' since we don't need it

        //    return File(pdfBytes, mimeType);
        //}

        //private ReportViewModelForBarCode GetClient1BarcodeReport(string barcodes)
        //{
        //    var report = repo.BarCodeRepository.GetEmptyBoxBarCodeReport(barcodes); // Reuse core logic
        //    report.FileName = "~/ReportsHolder/Client1Barcode.rdlc"; // New template
        //    //report.HeaderText = "CLIENT-1 BARCODE"; // Optional: Add new properties
        //    return report;
        //}
