    ...
    public class RacksController : Controller
    {
        ...
        // GET: /Racks/
         ...
         public ViewResult Index(int? page)
         {
             ...
             ViewBag.NoofRack = repo.RackRepository.All.Count();
             return View(repo.RackRepository.AllIncluding(Rack => Rack.Train, Rack => Rack.Train.Zone, Rack => Rack.Train.Zone.Floor, Rack => Rack.Train.Zone.Floor.Warehouse).OrderBy(o => o.RackName).ToPagedList(pageNumber, pageSize));
