...
{ 
    public class BarcodeMappingRepository : IBarcodeMappingRepository
    {
        ...
        public  ReportViewModelForBarcodeMapping MappingReport(long trID,int?page)
        {
            ...
            {
                //var emtBxBrcode = context.EmptyBoxeBarcodes.Where(b => b.BarCodeId == item.BarCodeId).FirstOrDefault();
                ...
                model.BarcodeNo = (context.BarCodes.Where(d => d.BarCodeId == item.BarCodeId).FirstOrDefault().BarCodeId * 5000 + 10 ).ToString();
