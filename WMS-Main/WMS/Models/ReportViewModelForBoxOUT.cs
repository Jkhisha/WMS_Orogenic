...
{
    public class ReportViewModelForBoxOUT
    {
        

          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForBoxOUT()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForBoxOUT.ReportFormat.Word: return ".doc";
                      case ReportViewModelForBoxOUT.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
