...
{ 
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        public IEnumerable<Department> GetDepartmentsByClientId(long clientId)
        {
            return context.Departments.Where(d => d.ClientID == clientId).ToList();
        }
        ...
        public IList<Department> GetAllDepartmentByClientId(long clientId)
        {

            List<Department> listOfItem = context.Departments.Where(d => d.ClientID == clientId).OrderBy(d => d.DepartmentName).ToList();
