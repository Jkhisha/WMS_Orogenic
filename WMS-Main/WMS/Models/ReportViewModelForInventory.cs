...
{
    public class ReportViewModelForInventory
    {
        
          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForInventory()
        {
          ...
          public long TotalBoxCount { get; set; }
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForInventory.ReportFormat.Word: return ".doc";
                      case ReportViewModelForInventory.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
          ...
          public byte[] RenderReport()
          {
              ...
              localReport.SetParameters(new ReportParameter("WareHouseName", this.WareHouseName));
              localReport.SetParameters(new ReportParameter("ClientName", this.ClientName));
              localReport.SetParameters(new ReportParameter("TotalBoxCount", this.TotalBoxCount.ToString()));
