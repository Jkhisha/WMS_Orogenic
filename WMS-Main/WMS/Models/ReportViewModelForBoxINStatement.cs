...
{
    public class ReportViewModelForBoxINStatement
    {
        
          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForBoxINStatement()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForBoxINStatement.ReportFormat.Word: return ".doc";
                      case ReportViewModelForBoxINStatement.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
