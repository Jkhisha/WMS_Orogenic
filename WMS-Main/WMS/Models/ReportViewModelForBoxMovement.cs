...
{
    public class ReportViewModelForBoxMovement
    {
        public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
        public ReportViewModelForBoxMovement()
        {
        ...
        public string ReporExportExtention
        {
            get
            {
                switch (this.Format)
                {
                    case ReportViewModelForBoxMovement.ReportFormat.Word: return ".doc";
                    case ReportViewModelForBoxMovement.ReportFormat.Excel: return ".xls";
                    default:
                        return ".pdf";
                }
            }
        ...
        public byte[] RenderReport()
        {
            ...
            localReport.SetParameters(new ReportParameter("BoxName", this.BoxName));

            localReport.SetParameters(new ReportParameter("BoxNo", this.BoxNo));
