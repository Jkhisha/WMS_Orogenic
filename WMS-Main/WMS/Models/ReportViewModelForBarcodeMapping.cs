...
{
    public class ReportViewModelForBarcodeMapping
    {
        
        

          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForBarcodeMapping()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForBarcodeMapping.ReportFormat.Word: return ".doc";
                      case ReportViewModelForBarcodeMapping.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
          ...
          public byte[] RenderReport()
          {
              ...
              localReport.SetParameters(new ReportParameter("DepartmentName", this.DepartmentName));
