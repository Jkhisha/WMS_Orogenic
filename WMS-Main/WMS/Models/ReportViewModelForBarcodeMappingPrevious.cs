...
{
    public class ReportViewModelForBarcodeMappingPrevious
    {

        

          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForBarcodeMappingPrevious()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForBarcodeMappingPrevious.ReportFormat.Word: return ".doc";
                      case ReportViewModelForBarcodeMappingPrevious.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
