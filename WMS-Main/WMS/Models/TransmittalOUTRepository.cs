...
{ 
    public class TransmittalOUTRepository : ITransmittalOUTRepository
    {
        ...
        public TransmittalOUT GetByTrNo(string id)
        {
            return context.TransmittalOUTs.Where(r => r.TransmittalNo == id).FirstOrDefault();
        }
        ...
        {
            return context.TransmittalOUTs.OrderByDescending(o => o.TransmittalDate).ToPagedList(pageNumber, pageSize);
        }
        public PagedList.IPagedList<TransmittalOUT> GetAllByClientId(int pageNumber, int pageSize,long ClientId)
        {
            return context.TransmittalOUTs.Where(s=>s.ClientID==ClientId).ToList().OrderByDescending(o => o.TransmittalNo).ToPagedList(pageNumber, pageSize);
        }

        public PagedList.IPagedList<TransmittalOUT> GetListByTrNo(int pageNumber, int pageSize, string trNumber)
        {
            return context.TransmittalOUTs.Where(s => s.TransmittalNo == trNumber).ToList().OrderByDescending(o => o.TransmittalNo).ToPagedList(pageNumber, pageSize);
        }
