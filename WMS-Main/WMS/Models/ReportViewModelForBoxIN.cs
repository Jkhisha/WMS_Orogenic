...
{
    public class ReportViewModelForBoxIN
    {

          public enum ReportFormat { PDF = 1, Word = 2, Excel = 3 }
          public ReportViewModelForBoxIN()
        {
          ...
          public string ReporExportExtention
          {
              get
              {
                  switch (this.Format)
                  {
                      case ReportViewModelForBoxIN.ReportFormat.Word: return ".doc";
                      case ReportViewModelForBoxIN.ReportFormat.Excel: return ".xls";
                      default:
                          return ".pdf";
                  }
              }
