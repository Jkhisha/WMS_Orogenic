...
namespace WareHouseMVC.Models
{
    public class TransmittalINRepository : ITransmittalINRepository
    {
        ...
        public TransmittalIN GetByTrNo(string id)
        {
            return context.TransmittalINs.Where(r => r.TransmittalNo == id).FirstOrDefault();
        }
        ...
        {
            return context.TransmittalINs.OrderByDescending(a => a.TransmittalDate).ToPagedList(pageNumber, pageSize);
        }
